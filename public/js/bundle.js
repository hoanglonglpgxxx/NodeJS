...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (l) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(l.coordinates).setHTML("<p>Day ".concat(l.day, ": ").concat(l.description, "</p>")).addTo(map);
    bounds.extend(l.coordinates);
    var buttons = document.getElementsByClassName('mapboxgl-popup-close-button');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'update-password' : 'update-data';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Information updated successfully!');
            setTimeout(function () {
...
var initializeStripe = function initializeStripe(stripePublicKey) {
  if (typeof Stripe === 'undefined') {
    return null;
  }
  return Stripe(stripePublicKey);
};
var stripe = initializeStripe('pk_test_51PZ1LcCIAEQH1pNppKu6pdTp8dZucFFhnCroB4vqNcAB6Pw2sdnwWdKzdJHy4QDSnKWb3x9PHzsx9ZCfwCWvy9eD00TKQYy8Rg');
...
var USER_DATA_FORM = document.querySelector('.form-user-data');
var USER_PASSWORD_FORM = document.querySelector('.form-user-password');
var BOOKING_BTN = document.querySelector('#book-tour');
if (MAP_BOX) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (USER_PASSWORD_FORM) {
    USER_PASSWORD_FORM.addEventListener('submit', /*#__PURE__*/function () {
